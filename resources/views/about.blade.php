  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-7 position-relative about-img" style="background-image: url({{ asset('storage/about/'.$isi->foto) }}) ;" data-aos="fade-up" data-aos-delay="150">
          </div>
          <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
            <div class="content ps-0 ps-lg-5">
              ...
              <div class="position-relative mt-4">
                <img src="{{ asset('storage/about/'.$isi->foto) }}" class="img-fluid" alt="">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item text-center w-100 h-100">
              <span data-purecounter-start="0" data-purecounter-end="{{ $hitungmakanans }}" data-purecounter-duration="1" class="purecounter"></span>
              <p>Makanan</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item text-center w-100 h-100">
              <span data-purecounter-start="0" data-purecounter-end="{{ $hitungminumans }}" data-purecounter-duration="1" class="purecounter"></span>
              <p>Minuman</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item text-center w-100 h-100">
              <span data-purecounter-start="0" data-purecounter-end="{{ $hitungpenjuals }}" data-purecounter-duration="1" class="purecounter"></span>
              <p>Penjual</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item text-center w-100 h-100">
              <span data-purecounter-start="0" data-purecounter-end="{{ $hitungpasars }}" data-purecounter-duration="1" class="purecounter"></span>
              <p>Pasar</p>
            </div>
          </div><!-- End Stats Item -->
            ...
            <div class="testimonial-item">
              <div class="row gy-4 justify-content-center">
                ...
                <div class="col-lg-2 text-center">
                  <img src="{{ asset('storage/testimoni/'.$isi->foto) }}" class="img-fluid testimonial-img" alt="">
                </div>
              </div>
            </div>
