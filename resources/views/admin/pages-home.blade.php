            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @foreach ($homes as $isi)
                        ...
                        <form method="POST" action="{{ url('pages-home/' . $isi->id) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img class="col-sm-2 col-form-label"
                                        src="{{ asset('storage/home/' . $isi->foto) }}">
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary"
                                            onclick="return confirm('Apakah Yakin Udpate Data ?')">Update</button>
                                    </div>
                                </div>
