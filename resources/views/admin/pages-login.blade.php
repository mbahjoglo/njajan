                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="loginproses" method="POST" class="row g-3 needs-validation"
                                        novalidate>
                                        @csrf
                                        <div class="col-12">
                                        ...
                                        {{-- <div class="col-12">
                                            <p class="small mb-0">Tidak punya akun? <a href="register">Buat sebuah
                                                    akun</a></p>
                                        </div> --}}
                                        <div class="col-12">
                                            <p class="small mb-0">Kembali ke <a href="/">Halaman Utama</a></p>
                                        </div>
                                    </form>
