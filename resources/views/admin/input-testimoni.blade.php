...
<main id="main" class="main">
    ...
    <div class="card">
    <div class="card-body">
        <h5 class="card-title">Input Testimoni</h5>

        <!-- General Form Elements -->
        <form method="POST" action="{{ url('input-testimoni') }}" enctype="multipart/form-data">
            @csrf
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
            <button type="submit" class="btn btn-primary" onclick="return confirm('Apakah Yakin Menambahkan Data Testimoni ?')">Tambah</button>
            </div>
        </div>
