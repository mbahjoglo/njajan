        ...
        <div class="card">
            <div class="card-body">
                ...
                <tbody>
                    <tr>    
                    <td>
                        <img width="100" src="{{ asset('storage/makanan/'.$isi->foto) }}" alt="" title="">
                    </td>
                    <td>{{ $isi->nama }}</td>
                    <td>{{ $isi->penjual }}</td>
                    <td>{{ $isi->lokasi }}</td>
                    ...
                    <td>
                        ...
                        <!-- hapus -->
                        <form action="{{ url('/input-produk-makanan/'. $isi->id) }}" method="post">
                            @csrf
                            <input type="hidden" name="_method" value="DELETE">
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah Yakin Menghapus Data ?')"><i class="bi bi-trash"></i></button>
                        </form>
                    </td>
                    </tr>
                </tbody>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Update Makanan</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">

                            @foreach ($data_makanans as $isi)
                            <form method="POST" action="{{ url('pages-menu-makanan/'. $isi->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Lokasi Pasar</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="number" class="form-control" name="harga" value="{{ $isi->harga }}">
                                    </div>
                                </div>
                        
                                <div class="row mb-3">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">No.Hp/wa</label>
                                    <div class="col-sm-10">
                                    <input type="number" class="form-control" name="nomor" value="{{ $isi->nomor }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                    <img class="col-sm-2 col-form-label img-fluid" src="{{ asset('storage/makanan/'.$isi->foto) }}">
                                </div>
