                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                                            data-bs-target="#makanan{{ $isi->id_makanan }}">
                                            <i class="bi bi-arrow-clockwise"></i>
                                        </button>

                                        <!-- hapus -->
                                        <form action="{{ url('/pages-menu-makanan/' . $isi->id_makanan) }}"
                                            method="post">
                                            @csrf
                                        ...
                                        <div class="modal fade" id="makanan{{ $isi->id_makanan }}" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form method="POST"
                                                        action="{{ url('pages-menu-makanan/' . $isi->id_makanan) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a
                                                                    href="{{ url('pages-menu-makanan/' . $isi->id_makanan) }}">
                                                                    <button type="submit"
