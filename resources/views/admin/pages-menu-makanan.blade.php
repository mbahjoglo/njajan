                    ...
                    <table class="table">
                        ...
                        @foreach ($datamakanans as $isi)
                            <tbody>
                                <tr>
                                    <td>
                                        <img width="100" src="{{ asset('storage/makanan/' . $isi->fotomakanan) }}"
                                            alt="" title="">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                                            data-bs-target="#makanan{{ $isi->id }}">
                                            <i class="bi bi-arrow-clockwise"></i>
                                        </button>

                                        <!-- hapus -->
                                        <form action="{{ url('/pages-menu-makanan/' . $isi->id) }}" method="post">
                                            @csrf
                                ...
                                <div class="modal fade" id="makanan{{ $isi->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form method="POST" action="{{ url('pages-menu-makanan/' . $isi->id) }}"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control"
                                                                name="namamakanan" value="{{ $isi->namamakanan }}">
                                                        </div>
                                                    </div>

                                                    <div class="row mb-3">
                                                        <label for="inputNumber" class="col-sm-2 col-form-label">Rp.
                                                        </label>
                                                        <div class="col-sm-10">
