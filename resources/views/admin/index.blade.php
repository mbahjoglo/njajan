      ...
      <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="#">Text Judul</a></li>
                    <li><a class="dropdown-item" href="#">Deskripsi</a></li>
                    <li><a class="dropdown-item" href="#">Link Video</a></li>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>Judul</h6>
                      <span class="text-muted small pt-2 ps-1">Deskripsi</span>
                    </div>
                  </div>
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="#">open kecamatan</a></li>
                  </ul>
                </div>

                <div class="card-body">
                  <h5 class="card-title">Kecamatan <span>| njajan</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>1</h6>
                      <span class="text-muted small pt-2 ps-1">kecamatan</span>
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">Daftar <span>| Menu</span></h5>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Produk Dari Beberapa <span>| Kecamatan</span></h5>
