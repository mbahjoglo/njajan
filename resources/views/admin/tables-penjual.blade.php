...
<main id="main" class="main">
    ...
    <nav>
        ...
        <li class="breadcrumb-item active">Table | Penjual</li>
        </ol>
    </nav>
    </div>
    <!-- End Page Title -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <tbody>
                    <tr>
                    <td>
                        <img width="100" src="{{ asset('storage/penjual/'.$isi->foto) }}" alt="" title="">
                    </td>
                    <td>{{ $isi->nama }}</td>
                    <td>{{ $isi->alamat }}</td>
                    <td>{{ $isi->pasar }}</td>
                    ...
                    <td>
                        <a href="{{ url('/update-makanan/'. $isi->id) }}">
                            <button type="button" class="btn btn-secondary"><i class="bi bi-arrow-clockwise"></i></button>
                        </a>
                        
                        <form action="{{ url('/input-penjual/'. $isi->id) }}" method="post">
                            @csrf
                            <input type="hidden" name="_method" value="DELETE">
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah Yakin Menghapus Data Penjual?')"><i class="bi bi-trash"></i></button>
                        </form>
                    </td>
                    </tr>
                </tbody>
