...
<main id="main" class="main">
    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Table Testimoni</h5>
                ...
                <tbody>
                    <tr>
                    <td>
                        <img width="100" src="{{ asset('storage/testimoni/'.$isi->foto) }}" alt="" title="">
                    </td>
                    <td>{{ $isi->nama }}</td>
                    <td>{{ $isi->deskripsi }}</td>
                    <td>{{ $isi->jabatan }}</td>
                    <td>
                        ...
                        <form action="{{ url('/input-testimoni/'. $isi->id) }}" method="post">
                            ...
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah Yakin Menghapus Data Testimoni ?')"><i class="bi bi-trash"></i></button>
                        </form>
                    </td>
                    </tr>
                </tbody>
