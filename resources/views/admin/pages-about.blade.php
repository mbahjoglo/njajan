...
<head>
    ...
    <title>About | Admin njajan</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">View About Page</h5>

                    <!-- General Form Elements -->
                    @foreach ($data_abouts as $isi)
                        <!-- General Form Elements -->
                        <form method="POST" action="{{ url('pages-about/' . $isi->id) }}"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Text Header</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img class="col-sm-5 col-form-label img-fluid"
                                        src="{{ asset('storage/about/' . $isi->foto) }}">
                                </div>
                                <div class="row mb-3">
                                    <label for="inputNumber" class="col-sm-2 col-form-label">Foto Upload</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="file" id="formFile" name="foto">
                                        <input class="form-control" type="hidden" id="formFile" name="fotolama"
                                            value="{{ $isi->foto }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
