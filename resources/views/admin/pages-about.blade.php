...
<main id="main" class="main">
    ...
    <div class="card-body">
        ...
        <!-- General Form Elements -->
        <form method="POST" action="{{ url('pages-about/'.$isi->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
            <img class="col-sm-5 col-form-label img-fluid" src="{{ asset('storage/about/'.$isi->foto) }}">
        </div>
        <div class="row mb-3">
