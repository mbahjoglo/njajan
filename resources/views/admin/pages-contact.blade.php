...
<main id="main" class="main">
    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Table Contact</h5>
        
                <!-- General Form Elements -->
                @foreach ($datas as $isi)
                    
                
                <form method="POST" action="{{ url('pages-contact/'.$isi->id) }}">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                    <input type="email" class="form-control" name="email" value="{{ $isi->email }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="open_admin" value="{{ $isi->open_admin }}">
                    </div>
                </div>
